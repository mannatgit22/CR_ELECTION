<%@ page language="java" contentType="application/json; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ page import="java.sql.*" %>
        <% String sic=request.getParameter("sic"); if (sic==null || sic.trim().isEmpty()) {
            ...
            conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/cr_election_db", "safe_election"
            , "VeryStrongPassword123!" ); String sql="DELETE FROM candidates WHERE sic = ?" ;
